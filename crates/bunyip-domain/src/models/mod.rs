...
pub use token::{
    ...
    CreateTrustedDevice, EmailChangeRequest, EmailVerificationToken, LoginApprovalCode,
    LoginDevice, MagicLinkToken, PasswordResetToken, RefreshToken, SessionInfo, TrustedDevice,
    TrustedDeviceInfo,
};
